...
class OmeZarrWriter:
    ...
    def _downsample_pyramid_on_disk(self, parent, paths) -> None:
        """
    ...
    def finalize(self, res, n_levels=5) -> None:
        """
...
class AnalysisOmeZarrWriter(OmeZarrWriter):
    ...
    def _downsample_to_resolution(self, parent, source_path, target_path, target_shape) -> None:
    ...
    def finalize(self, res, target_resolutions_um=(10, 25, 50, 100), n_levels=None, make_isotropic=True) -> None:
        """
