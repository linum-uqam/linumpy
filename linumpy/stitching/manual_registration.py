...
class ManualImageCorrection:
    ...
    def __init__(self, data, resolution, downsample_factor, transforms=None, custom_ranges=None) -> None:
    ...
    def on_change_scaling(self, scaling_range) -> None:
    ...
    def on_change_y(self, val) -> None:
        self.current_y = int(val)
        self.axim_b.set(data=self.get_view_b())
        self.fig.canvas.draw_idle()

    def on_change_x(self, val) -> None:
        self.current_x = int(val)
        self.axim_a.set(data=self.get_view_a())
        self.fig.canvas.draw_idle()

    def on_change_offset_a(self, val) -> None:
    ...
    def on_change_offset_b(self, val) -> None:
    ...
    def on_change_theta(self, val) -> None:
    ...
    def on_change_ref_z(self, label) -> None:
