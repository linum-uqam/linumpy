...
def _build_arg_parser() -> argparse.ArgumentParser:
    ...
    p.add_argument("--n_bins", type=int, default=512, help="(histogram mode) Number of histogram bins. [%(default)s]")
    p.add_argument(
        "--tissue_threshold",
        type=float,
        default=0.0,
    ...
    p.add_argument(
        ...
        type=int,
        default=None,
        help="Fixed number of power-of-2 pyramid levels (overrides --pyramid_resolutions). [%(default)s]",
    )
    p.add_argument(
