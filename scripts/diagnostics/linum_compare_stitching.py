...
def main() -> None:
    ...
    metrics = {
        ...
        args.label1: {"vertical_seam_sharpness": float(m1_v), "horizontal_seam_sharpness": float(m1_h)},
        args.label2: {"vertical_seam_sharpness": float(m2_v), "horizontal_seam_sharpness": float(m2_h)},
