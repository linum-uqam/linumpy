...
def _build_arg_parser():
    ...
    p.add_argument("--exclude_first", type=int, default=1,
                   help="Exclude first N slices as calibration slices (default: 1)")
    ...
    galvo_group.add_argument("--galvo_threshold", type=float, default=0.6,
                             help="Confidence threshold for galvo fix (default: 0.6)")
...
def write_slice_config(output_file: Path, slice_ids: list, exclude_ids: list = None,
                       galvo_results: dict = None, first_slice_excludes: list = None):
